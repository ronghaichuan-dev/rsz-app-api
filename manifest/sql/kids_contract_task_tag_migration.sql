...
CREATE TABLE IF NOT EXISTS kids_contract_task_tag (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    task_tag_id VARCHAR(128) NOT NULL COMMENT '合同任务标签标识',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同任务标签';
