-- Clearwave 合同任务完成、取消、星星流水与余额事实表。

CREATE TABLE IF NOT EXISTS kids_contract_task_completion (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    completion_id VARCHAR(128) NOT NULL COMMENT '合同完成标识',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同任务完成审计';

CREATE TABLE IF NOT EXISTS kids_contract_task_cancellation (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    cancellation_id VARCHAR(128) NOT NULL COMMENT '合同取消标识',
    completion_id VARCHAR(128) NOT NULL COMMENT '合同完成标识',
    ...
    UNIQUE KEY uk_completion_id (completion_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同任务取消审计';

CREATE TABLE IF NOT EXISTS kids_contract_ledger (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    ledger_id VARCHAR(128) NOT NULL COMMENT '合同流水标识',
    circle_id VARCHAR(128) NOT NULL COMMENT '合同圈子标识',
    member_id VARCHAR(128) NOT NULL COMMENT '合同成员标识',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同星星审计流水';

CREATE TABLE IF NOT EXISTS kids_contract_balance (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    circle_id VARCHAR(128) NOT NULL COMMENT '合同圈子标识',
    member_id VARCHAR(128) NOT NULL COMMENT '合同成员标识',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同成员星星余额';
