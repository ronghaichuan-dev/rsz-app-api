...
CREATE TABLE IF NOT EXISTS kids_contract_sequence (
    ...
    PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同提交序列';

INSERT INTO kids_contract_sequence (id, next_commit_sequence)
VALUES (1, 1)
