-- Clearwave Backend Contract v1 持久化基础表。
-- 本迁移只属于 kids 微服务自己的数据库，不与其他应用共用。

CREATE TABLE IF NOT EXISTS kids_contract_session (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    session_id VARCHAR(128) NOT NULL COMMENT '合同会话标识',
    account_id VARCHAR(128) NOT NULL DEFAULT '' COMMENT '合同账号标识',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同会话';

CREATE TABLE IF NOT EXISTS kids_contract_idempotency (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    principal_scope VARCHAR(256) NOT NULL COMMENT '主体和成员作用域',
    idempotency_key VARCHAR(256) NOT NULL COMMENT '幂等键',
    operation_id VARCHAR(128) NOT NULL COMMENT '合同操作标识',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同幂等记录';

CREATE TABLE IF NOT EXISTS kids_contract_commit (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    commit_id VARCHAR(128) NOT NULL COMMENT '合同提交标识',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同同步提交';

CREATE TABLE IF NOT EXISTS kids_contract_receipt (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    receipt_id VARCHAR(128) NOT NULL COMMENT '合同回执标识',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同写入回执';

CREATE TABLE IF NOT EXISTS kids_contract_asset_upload (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同资产上传';

CREATE TABLE IF NOT EXISTS kids_contract_asset (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    ...
    UNIQUE KEY uk_upload_id (upload_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同已提交资产';

CREATE TABLE IF NOT EXISTS kids_contract_feedback (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同反馈';

CREATE TABLE IF NOT EXISTS kids_contract_entitlement (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='kids合同权益快照';
