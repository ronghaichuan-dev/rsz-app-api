...
// KidsContractAdministrator is the golang structure for table kids_contract_administrator.
type KidsContractAdministrator struct {
	Id              uint64      `json:"id"              orm:"id"               description:"主键"`      // 主键
	AdministratorId string      `json:"administratorId" orm:"administrator_id" description:"合同管理员标识"` // 合同管理员标识
