...
// KidsContractCircleSelection is the golang structure for table kids_contract_circle_selection.
type KidsContractCircleSelection struct {
	Id              uint64      `json:"id"              orm:"id"                description:"主键"`     // 主键
	SelectionId     string      `json:"selectionId"     orm:"selection_id"      description:"合同选择标识"` // 合同选择标识
