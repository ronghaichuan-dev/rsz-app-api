...
// KidsTaskCompletion is the golang structure of table kids_task_completion for DAO operations like Where/Data.
type KidsTaskCompletion struct {
	g.Meta         `orm:"table:kids_task_completion, do:true"`
	Id             any         // 主键
