...
// KidsRequestDeduplication is the golang structure of table kids_request_deduplication for DAO operations like Where/Data.
type KidsRequestDeduplication struct {
	g.Meta               `orm:"table:kids_request_deduplication, do:true"`
	Id                   any         // 主键
