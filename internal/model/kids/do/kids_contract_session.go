...
// KidsContractSession is the golang structure of table kids_contract_session for DAO operations like Where/Data.
type KidsContractSession struct {
	g.Meta                `orm:"table:kids_contract_session, do:true"`
	Id                    any         // 主键
	SessionId             any         // 合同会话标识
