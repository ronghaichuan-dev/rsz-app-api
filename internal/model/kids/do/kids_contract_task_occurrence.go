...
// KidsContractTaskOccurrence is the golang structure of table kids_contract_task_occurrence for DAO operations like Where/Data.
type KidsContractTaskOccurrence struct {
	g.Meta                `orm:"table:kids_contract_task_occurrence, do:true"`
	Id                    any         // 内部主键
	CircleId              any         // 合同圈子标识
	TaskId                any         // 合同任务标识
	MemberId              any         // 合同成员标识
