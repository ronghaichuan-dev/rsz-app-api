...
// RequestInput 在 Controller 层严格解析一个合同路由的 HTTP 参数和 JSON 请求体。
...
// SuccessResponse 将 Service 输出转换为合同成功响应。
...
// v1BearerToken 仅接受合同规定的 Bearer credential，避免把其他 scheme 当作访问令牌。
